...
function Invoke-Pymedia {
    ...
    Write-Host "> uv run main encode $($CmdArgs -join ' ')" -ForegroundColor DarkGray
    & uv run main encode @CmdArgs
...
Invoke-Pymedia -Label "4. Crop + scale 480 (1080p)" -CmdArgs @("tests/fixtures/valid_encode/clip_06.mp4", "-c", "200,200,100,100", "-s", "480", "-o", "04_crop_scale.mp4")
Invoke-Pymedia -Label "5. Scale 480 en 720p" -CmdArgs @("tests/fixtures/valid_encode/clip_05.mp4", "-s", "480", "-o", "05_scale.mp4")
...
Invoke-Pymedia -Label "7. Gyrate 90 (1080p)" -CmdArgs @("tests/fixtures/valid_encode/clip_06.mp4", "-g", "90", "-o", "07_gyrate90.mp4")
Invoke-Pymedia -Label "8. Gyrate 180 (480p)" -CmdArgs @("tests/fixtures/valid_encode/clip_07.mp4", "-g", "180", "-o", "08_gyrate180.mp4")
Invoke-Pymedia -Label "9. Gyrate 270 (360p)" -CmdArgs @("tests/fixtures/valid_concat/clip_02.mp4", "-g", "270", "-o", "09_gyrate270.mp4")
Invoke-Pymedia -Label "10. Gyrate 90 + crop 200,100,50,50 (720p)" -CmdArgs @("tests/fixtures/valid_encode/clip_05.mp4", "-g", "90", "-c", "200,100,50,50", "-o", "10_gyrate_crop.mp4")

# ─────────── 11-15: combinaciones y casos especiales ───────────
Invoke-Pymedia -Label "11. Gyrate 270 + scale 480" -CmdArgs @("tests/fixtures/valid_encode/clip_06.mp4", "-g", "270", "-s", "480", "-o", "11_gyrate_scale.mp4")
Invoke-Pymedia -Label "12. Todo: crop + scale + gyrate + remux (1080p)" -CmdArgs @("tests/fixtures/valid_encode/clip_06.mp4", "-c", "200,200,100,100", "-s", "720", "-g", "90", "-r", "-o", "12_todo.mp4")
