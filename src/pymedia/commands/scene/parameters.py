"""Comando ``scene``: procesador de parámetros."""
...
from pymedia.mixins.image_mixin import ImageQualityMixin, SceneMixin
...
class SceneParameters(
    ...
    """Parámetros utilizados por el comando Scene."""
    ...
    def load(
        ...
        Returns:
            Parámetros procesados y validados para el comando scene.

        Raises:
            InvalidContainerError: Si la extensión no es una imagen soportada.
            InvalidParameterError: Si el formato de imagen no está soportado o
                la marca de inicio es posterior a la de fin.
