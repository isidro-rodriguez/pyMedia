"""Comando ``join``: compositor de comandos ffmpeg."""
...
class JoinCmd:
    """Compone el comando de ffmpeg para unir múltiples vídeos."""
    ...
    def create(self, list_txt: Path) -> list[str]:
        ...
        Raises:
            MissingParameterError: Si `media_list` no se pudo obtener.
