"""Comando ``interval``: procesador de parámetros."""
...
from pymedia.mixins.fps_mixin import FpsImageMixin
...
class IntervalParameters(
    ...
    """Parámetros utilizados por el comando Interval."""
    ...
    def load(
        ...
        Returns:
            Parámetros procesados y validados para el comando interval.
